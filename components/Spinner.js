    ...
    return (
        <div className="flex justify-center items-center mx-auto min-h-screen">
            <svg xmlns="http://www.w3.org/2000/svg"  style={{margin: "auto",  display: "block" ,  shapeRendering: "auto"}} width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                <rect x="17.5" y="30" width="15" height="40" fill="#ff1500">
                ...
                <rect x="42.5" y="30" width="15" height="40" fill="rgba(255, 0, 0, 0.7348387096774194)">
                ...
                <rect x="67.5" y="30" width="15" height="40" fill="rgba(255, 0, 0, 0.5838709677419355)">
